...
# Based on matlab code by Prof. Moeti Ncube, "This code replicates the results
# for Figure 4, of the original Schwartz-Smith 2000 paper (Short-Term Variations
# and Long-Term Dynamics in Commodity Prices)".
# http://www.mathworks.co.uk/matlabcentral/fileexchange/29745-simulation-of-schwartz-smith
# -two-factor-model
...
def main():
    ...
    if not os.path.exists(futuresDataPath):
        msg = "File containing of futures not found: %s" % futuresDataPath
        raise Exception(msg)
